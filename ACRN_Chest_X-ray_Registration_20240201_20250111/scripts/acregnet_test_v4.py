...
from acregnet.datasets import ImagePairsDatasetTest_V4
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_file', type=str, default='../results/DRLung/ACRegNet/train/model_v4.pt')
    ...
    if args.save_images:
        output_dir = os.path.join(args.results_dir, 'output_v4')

    test_dataset = ImagePairsDatasetTest_V4(args.test_images_file, args.test_labels_file, mode='test')
