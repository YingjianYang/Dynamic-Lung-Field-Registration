...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_labels_file', type=str, default='../data/DRLung/split/valid_labels.txt')
    parser.add_argument('--model_file', type=str, default='../results/DRLung/AENet/train/model.pt')
    parser.add_argument('--device', type=str, default='cuda')
    parser.add_argument('--results_dir', type=str, default='../results/DRLung/AENet/valid')
