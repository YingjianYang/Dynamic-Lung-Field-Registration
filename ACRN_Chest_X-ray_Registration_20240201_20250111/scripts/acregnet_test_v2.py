...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_file', type=str, default='../results/DRLung/ACRegNet/train/model_v2.pt')
    ...
    if args.save_images:
        output_dir = os.path.join(args.results_dir, 'output_v2')
    ...
    with open(os.path.join(args.results_dir, 'run_args_v2.txt'), 'w') as f:
        for k, v in sorted(vars(args).items()):
            f.write(f'{k}: {v}\n')
